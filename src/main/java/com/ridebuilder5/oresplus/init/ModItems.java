...
import com.ridebuilder5.oresplus.items.tools.ToolAxe;
import com.ridebuilder5.oresplus.items.tools.ToolHammer;
import com.ridebuilder5.oresplus.items.tools.ToolHoe;
import com.ridebuilder5.oresplus.items.tools.ToolPickaxe;
import com.ridebuilder5.oresplus.items.tools.ToolSpade;
import com.ridebuilder5.oresplus.items.tools.ToolSword;
import com.ridebuilder5.oresplus.util.Reference;
import com.ridebuilder5.oresplus.items.ItemBase;
import com.ridebuilder5.oresplus.items.ItemHammer;
import com.ridebuilder5.oresplus.items.armor.ArmorBase;
...
public class ModItems {
	...
	public static final ToolMaterial MATERIAL_COPPER = EnumHelper.addToolMaterial("material_copper", 1, 225, 5.5F, 1.8F, 10);
	public static final ToolMaterial MATERIAL_NICKEL = EnumHelper.addToolMaterial("material_nickel", 1, 150, 4.5F, 1.2F, 10);
	public static final ToolMaterial MATERIAL_PLATINUM = EnumHelper.addToolMaterial("material_platinum", 2, 275, 6.5F, 2.5F, 15);
	public static final ToolMaterial MATERIAL_SILVER = EnumHelper.addToolMaterial("material_silver", 1, 200, 5.0F, 1.5F, 10);
	public static final ToolMaterial MATERIAL_ALUMINUM = EnumHelper.addToolMaterial("material_aluminum", 1, 175, 4.75F, 1.4F, 10);
	public static final ToolMaterial MATERIAL_LEAD = EnumHelper.addToolMaterial("material_lead", 2, 260, 6.25F, 2.25F, 15);
	public static final ToolMaterial MATERIAL_SILICON = EnumHelper.addToolMaterial("material_silicon", 1, 200, 5.0F, 1.6F, 10);
	public static final ToolMaterial MATERIAL_TIN = EnumHelper.addToolMaterial("material_tin", 1, 150, 4.5F, 1.2F, 10);
	...
	public static final Item RADON_GAS = new ItemBase("radon_gas");
	...
	public static final Item CURIUM_INGOT = new ItemBase("curium_ingot");
	...
	public static final ItemPickaxe SILICON_PICKAXE = new ToolPickaxe("silicon_pickaxe", MATERIAL_SILICON);
